...
public class SaveController : MonoBehaviour
{
    ...
    public void SaveAll()
    {
        if (!_isReset && _gameController != null)
        {
            ...
            GameControllerSave gameControllerSave = new GameControllerSave(
                _gameController.Money,
            ...
            SellerSave sellerSave = new SellerSave(_gameController._Seller.Money, _gameController._Seller.Lvl);
...
public class GameControllerSave : SaveBase
{
    ...
    public GameControllerSave(int money, int cash, int[] numbers, int level, Dictionary<int, DateTime> activeBooster)
    {
        Money = money;
        Cash = cash;
...
public class SellerSave : SaveBase
{
    ...
    public SellerSave(int money, int lvl)
    {
        Money = money;
        Lvl = lvl;
    }
